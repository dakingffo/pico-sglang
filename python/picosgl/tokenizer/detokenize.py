...
class DecodeStatus:
    ...
    decoded_str: str       = field(default_factory=str, init=False)
    read_offset: int       = field(default=0, init=False)  # length of read ids
    surr_offset: int       = field(default=0, init=False)  # length of surr ids
    sent_offset: int       = field(default=0, init=False)  # length of sent string
